...
public class CanadianPostalCodeUrbanImpl extends ASTWrapperPsiElement implements CanadianPostalCodeUrban {

  public CanadianPostalCodeUrbanImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CanadianPostalCodeVisitor visitor) {
    visitor.visitUrban(this);
  }
