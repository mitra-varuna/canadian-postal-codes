...
public class CanadianPostalCodeRuralImpl extends ASTWrapperPsiElement implements CanadianPostalCodeRural {

  public CanadianPostalCodeRuralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CanadianPostalCodeVisitor visitor) {
    visitor.visitRural(this);
  }
