...
public class CanadianPostalCodeLetterImpl extends ASTWrapperPsiElement implements CanadianPostalCodeLetter {

  public CanadianPostalCodeLetterImpl(@NotNull ASTNode node) {
    super(node);
  }
