...
public class CanadianPostalCodeDigitImpl extends ASTWrapperPsiElement implements CanadianPostalCodeDigit {

  public CanadianPostalCodeDigitImpl(@NotNull ASTNode node) {
    super(node);
  }
